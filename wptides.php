 ...
 * This action is documented in includes/class-wptides-activator.php
 */
function activate_wptides() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-wptides-activator.php';
	Wptides_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-wptides-deactivator.php
 */
...
register_activation_hook( __FILE__, 'activate_wptides' );
