...
class Wptides {
	...
	public function __construct() {
		if ( defined( 'WPTIDES_VERSION' ) ) {
			$this->version = WPTIDES_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wptides';
	 ...
	 *
	 * - Wptides_Loader. Orchestrates the hooks of the plugin.
	 * - Wptides_i18n. Defines internationalization functionality.
	 * - Wptides_Admin. Defines all hooks for the admin area.
	 * - Wptides_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wptides-i18n.php';
	 ...
	 *
	 * Uses the Wptides_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wptides_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wptides_Public( $this->get_plugin_name(), $this->get_version() );
