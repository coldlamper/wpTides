...
?>
<div>
	<div style="text-align: center;">Today's Tides for <?= ucwords(strtolower($station['name'])) ?>, <?= $station['state'] ?> - Station ID <?= $station['id']?></div>
	<div style="text-align: center;"><?= $station_datetime->format('F j, Y h:i:s A') ?></div>
